...
from pde_map_visualization import visualize_pde_parameters_on_map
        ...
        try:
            ...
            if predictions_df is not None:
                ...
                for col in eth_columns[:min(5, len(eth_columns))]:
                    ...
                    # If we have both predicted and 2006 data, create change map
                    base_col = f"{eth_name}_2006"
...
def create_model_visualizations(output_dir, da_coordinates_path=None, ethnicity_names=None, 
    ...
    try:
        ...
        if use_shapefile:
            ...
            pde_success = visualize_pde_parameters_on_map(
                visualizer=visualizer,
                interpretation_dir=interpretation_dir, 
                shapefile_path=shapefile_path,
                output_dir=output_dir
        ...
        success = standard_success or shapefile_success
